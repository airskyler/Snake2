...
public class Snake {
    ...
    // setting a constant integer variable for the direction
    ...
    // Initializing the boolean value for the hitWall and ateTail
    private boolean hitWall = false;
    private boolean ateTail = false;

    // Declaring boolean variable of hasWarp
...
//	}
    ...
    protected void moveSnake(){
        ...
        if (snakeHeadX >= maxX || snakeHeadX < 0 || snakeHeadY >= maxY || snakeHeadY < 0 ) {
            ...
            if (hasWarp) {
                ...
                //If Warp walls are turned on and if snake go into direction......
    ...
    public String toString(){
        ...
        for (int y = 0 ; y < maxY ; y++) {
            for (int x = 0 ; x < maxX ; x++){
                buf.append(snakeSquares[x][y]);
            }
            buf.append("\n");
        }
        String textsnake = buf.toString();
        return textsnake;
    }
